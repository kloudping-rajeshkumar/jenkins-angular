...
export class ProjectsComponent implements OnInit {
  ...
  public filterValue: string = "All Projects";
  ...
  resetform() {
    ...
    this.projectForm.reset(new Project({}));
  }
  ...
  public onFilterd() {
    ...
    this.data.getProjectGetAll(model).subscribe((res: any) => {
      this.lstProject=[];
  ...
  updateProject(formData: any) {
    ...
    if (formData != '') {
      ...
      this.data.updateProject(formData).subscribe((res: any) => {
        this.setTableData(this.filterValue);
         this.onFilterd();
  ...
  deleteProject(model: any) {
    ...
    if(id != undefined || '')
    {
      ...
      this.data.DeleteProject(this.deleteid).subscribe((res: any) => {
        if (res == true) {
          this.setTableData(this.filterValue);
          this.onFilterd();
  ...
  private setTableData(res: any): void {
    ...
    this.calculateTotalPages(this.lstProject.length, this.pageSize);
  }
